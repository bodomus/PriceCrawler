...
{
    private const string WorkerCategorySeedUrlsFilePath = "PriceCrawler.Worker/config/category-seed-urls.varus.json";
    ...
    public void CategorySeedUrlsFilePath_WhenContentRootIsWeb_ResolvesWorkerSeedFile()
    {
        ...
        var contentRoot = Path.Combine(repoRoot, "PriceCrawler.Web");
        var expectedSeedPath = Path.Combine(repoRoot, "PriceCrawler.Worker", "config", "category-seed-urls.varus.json");
