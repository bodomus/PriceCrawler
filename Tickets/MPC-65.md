...
Реализовать для `PriceCrawler.Worker` явные режимы и команды запуска, чтобы оператор мог запускать нужный сценарий без неоднозначного ручного разбора аргументов.
