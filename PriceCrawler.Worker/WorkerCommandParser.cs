...
public static class WorkerCommandParser
{
    ...
    public static string GetHelpText() =>
        ...
        Usage:
          PriceCrawler.Worker vegetables [--once]
          PriceCrawler.Worker catalog-refresh
          PriceCrawler.Worker collect-prices
          PriceCrawler.Worker run-all

        Legacy aliases:
          PriceCrawler.Worker --job vegetables [--once]
          PriceCrawler.Worker --job catalog-refresh
          PriceCrawler.Worker --job collect-prices
          PriceCrawler.Worker --collect-prices
